...
"%ProgramFiles%\dotnet\dotnet.exe" restore "..\ChemiStar.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
"%ProgramFiles%\dotnet\dotnet.exe" build "..\ChemiStar.sln" -p:Configuration=%releaseconfig% %buildoptions%
