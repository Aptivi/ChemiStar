...
"%ProgramFiles%\dotnet\dotnet.exe" restore "%ROOTDIR%\ChemiStar.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
:build
echo Building...
"%ProgramFiles%\dotnet\dotnet.exe" build "%ROOTDIR%\ChemiStar.sln" -p:Configuration=%releaseconfig% %buildoptions%
