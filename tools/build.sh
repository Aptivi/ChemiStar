...
"$dotnetpath" restore "../ChemiStar.sln" -p:Configuration=$releaseconf ${@:2}
checkerror $? "Failed to download packages"

# Build
echo Building...
"$dotnetpath" build "../ChemiStar.sln" -p:Configuration=$releaseconf ${@:2}
checkerror $? "Failed to build ChemiStar"
